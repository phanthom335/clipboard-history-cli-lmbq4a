    """
    Clipboard History Cli Lmbq4a
    ============================
    A fast CLI utility to monitor files and directories straight from the terminal.
    ...
    APP_NAME    = "Clipboard History Cli Lmbq4a"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="A fast CLI utility to monitor files and directories straight from the terminal.")
